...
public class RestBasics {
	...
	@Test
	public void runTestUsingExternalFilePayload() throws IOException {

		// Static JSON Payload handling from external File
		// Content of the file to String -> Content of file can convert into byte -> byte data to String
		RestAssured.baseURI = "https://rahulshettyacademy.com";
		given().log().all().queryParam("key", "qaclick123").header("Content-Type", "application/json")
		.body(new String(Files.readAllBytes(Paths.get("C:\\Capgemini\\Capgemini\\Forme\\Learnings\\API\\AddPlace.json"))))
